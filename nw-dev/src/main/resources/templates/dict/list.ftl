    ...
    <head>
        ...
        <script type="text/javascript">
                ...
                $('#showList').treegrid({
                    ...
                    columns : [[{
                        ...
                        formatter : function(value, row) {
                            ...
                            html += "<a href=\"javascript:void(0);\" onclick=\"javascript:doEdit('" + row.fdid + "','"+row.pid+"')\" >修改</a>&nbsp;";
            ...
            function doEdit(id, pid){
                displayDialog("修改", "icon-edit", "/dict/edit?fdid="+id, pid);
            }
            ...
            function add() {
                ...
                displayDialog("新增", "icon-add", "/dict/add?pid="+pid, pid);
            }
                    ...
                    buttons: [{
                        ...
                        handler: function () {
                            if (form.form('validate')) {
                                $.post("/dict/save", form.serialize(), function (res) {
                                    if (res.indexOf("true")>-1) {
                                        if (pid=='root') {
                                            parent.$("#viewTabs").tabs("getSelected").find("iframe")[0].contentWindow.$("#showList").treegrid("reload");
                                        } else {
