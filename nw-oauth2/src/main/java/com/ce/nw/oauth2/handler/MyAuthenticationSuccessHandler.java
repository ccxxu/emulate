...
import com.ce.nw.oauth2.utils.ServerResponse;
...
/**
 * 登录成功
 * http://localhost:8080/ca/oauth/authorize?response_type=code&client_id=um&redirect_uri=http://localhost:8094/test/login
